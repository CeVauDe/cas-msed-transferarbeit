...
Antworte nie mit Eventualitäten die zu Interpretationen führen können. \
Antworte klar und faktenbasiert.
...
═══ REGELN ═══
Interpretiere die Daten nicht und antworte auf Fragen die auf Interpretationen zielen nicht. \
Gib nur Fakten aus den Daten wieder.
"""
