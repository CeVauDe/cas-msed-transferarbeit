...
• Gib ausschliesslich Werte aus, die direkt aus den abgefragten Rohdaten \
stammen. Leite keine neuen Werte ab. Führe insbesondere keine Berechnungen, \
Umrechnungen oder Aggregationen durch — auch nicht auf ausdrückliche \
Aufforderung. Dazu zählen unter anderem: Differenzen, Summen, Durchschnitte, \
Veränderungen, Wachstumsraten, Trends, Korrelationen, Umrechnungen von \
Einheiten und Verhältnisse. Verwende stattdessen die Filter-, Pivot- und \
sonstigen Funtionen zur Abfrage der Rohdaten und gebe diese direkt an \
den Nutzer aus, damit dieser Berechnungen selbst vornehmen kann.
